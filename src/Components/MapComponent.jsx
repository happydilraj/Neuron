...
const MapComponent = ({boatsData, portsData, boatsAllData}) => {
  ...
  return (
    <>
      ...
      <SearchBoat map={map} showShips={showShips} setShowShips={setShowShips} showPorts={showPorts} setShowPorts={setShowPorts} boatsData={boatsData}  boatsAllData={boatsAllData} portsData={portsData}/>
